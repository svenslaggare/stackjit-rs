...
fn compute_null_check_elision_for_block_internal(function: &Function,
    ...
    for instruction_index in &basic_block.instructions {
        ...
        match &instruction.data {
            ...
            InstructionMIRData::DivideInt32(_, _, _) => {}
            ...
            InstructionMIRData::AndBoolConstant(_, _, _) => {}
...
fn test_no_branches1() {
    let mut function = Function::new(
        FunctionDeclaration::with_managed("test".to_owned(), vec![], TypeId::Array(Box::new(TypeId::Int32))),
        vec![],
        vec![
